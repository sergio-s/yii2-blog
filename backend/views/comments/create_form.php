...
<div class="comments-form">
    ...
    <?= $form->field($model, 'materialType')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'materialId')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'autorId')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'updaterId')->textInput(['maxlength' => true]) ?>
